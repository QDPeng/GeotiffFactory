...
public class TiffSaver {
    ...
    /**
     * Save bitmap to file with default {@link SaveOptions options}.
     *
     ...
     * @throws NotEnoughtMemoryException when there is no avalable memory for processing bitmap
...
//        bmp.getPixels(pixels, 0, bmp.getWidth(), 0, 0, bmp.getWidth(), bmp.getHeight());
    ...
    /**
     * Append bitmap to the end of existing file or create new file with default {@link SaveOptions options}.
     *
     * @param destination - file to write bitmap
     * @param bmp         - Bitmap for saving
     * @return true if bitmap was saved successful or false otherwise
...
//        bmp.getPixels(pixels, 0, bmp.getWidth(), 0, 0, bmp.getWidth(), bmp.getHeight());
    ...
    public static final class SaveOptions {
        ...
        /**
         * The number of pixels per {@link SaveOptions#resUnit} in the ImageWidth direction.
        ...
        /**
         * The number of pixels per {@link SaveOptions#resUnit} in the ImageHeight direction.
         * <p> It is not mandatory that the image be actually displayed or printed at the size implied by this parameter.
         * It is up to the application to use this information as it wishes.</p>
         * <p>Defualt value is 0</p>
         */
